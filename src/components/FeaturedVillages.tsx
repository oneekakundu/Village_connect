...
const FeaturedVillages: React.FC = () => {
  ...
  const villages = [
    ...
    },
    {
      ...
      hostImage: 'https://glam-magazine.pt/wp-content/uploads/2018/04/Maria-Fernandes_Promo-820x500.jpg',
    ...
    },
    {
      ...
      hostImage: 'https://mymodernmet.com/wp/wp-content/uploads/2019/09/100k-ai-faces-3.jpg',
