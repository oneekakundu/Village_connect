...
const FeaturedVillages: React.FC = () => {
  ...
  return (
    <section id="villages" className="py-20 bg-gradient-to-br from-primary-100 to-primary-200 relative overflow-hidden">
      {/* Background Art */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {villages.map((village, index) => (
            <div
              key={village.id}
              className="bg-primary-50 rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 cursor-pointer group border border-accent-200 animate-fade-in"
            ...
            >
              ...
              <div className="relative overflow-hidden h-64">
                ...
                {/* Image Counter */}
                <div className="absolute top-4 left-4 bg-primary-800 bg-opacity-80 text-primary-50 px-3 py-1 rounded-full text-sm flex items-center space-x-1">
                ...
                {/* Instant Book Badge */}
                {village.instantBook && (
                  <div className="absolute top-4 right-16 bg-accent-500 text-primary-50 px-3 py-1 rounded-full text-sm font-medium animate-pulse">
                    Instant Book
                  </div>
                )}
                ...
                <button
                  ...
                  className="absolute top-4 right-4 bg-primary-50 bg-opacity-90 p-2 rounded-full hover:bg-opacity-100 transition-all transform hover:scale-110"
                >
                  <Heart 
                    className={`w-5 h-5 ${
                ...
                {village.offlineBooking && (
                  <div className="absolute bottom-4 right-4 bg-primary-50 bg-opacity-90 p-2 rounded-full" title="SMS/Call booking available">
                    <Phone className="w-4 h-4 text-accent-600" />
                  </div>
                )}

                {/* Special Feature Badge */}
                <div className="absolute bottom-4 left-4 bg-terracotta-500 text-primary-50 px-3 py-1 rounded-full text-sm font-medium">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium text-primary-700">{village.rating}</span>
                    <span className="text-primary-500 text-sm ml-1">({village.reviews})</span>
                  </div>
                </div>

                {/* Village Name */}
                <h3 className="text-xl font-bold text-primary-800 mb-2 font-serif group-hover:text-accent-700 transition-colors">
                  {village.name}
                </h3>
                ...
                <div className="flex items-center mb-4">
                  ...
                  />
                  <div>
                    <p className="text-sm text-primary-500">Hosted by</p>
                ...
                {/* Experiences */}
                <div className="mb-4">
                  <p className="text-sm text-primary-500 mb-2">Popular experiences:</p>
                  <div className="flex flex-wrap gap-2">
                    ...
                    {village.experiences.length > 2 && (
                      <span className="bg-primary-200 text-primary-600 px-3 py-1 rounded-full text-xs">
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-2 flex-wrap">
                    {village.ecoFeatures.map((feature, index) => (
                      <div key={index} className="flex items-center text-sage-600 bg-sage-100 px-2 py-1 rounded-full">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-2xl font-bold text-primary-800">₹{village.pricePerNight}</span>
                    <span className="text-primary-500 text-sm"> / night</span>
                  </div>
                  <button 
                    onClick={() => handleBookNow(village)}
                    className="bg-gradient-to-r from-accent-500 to-accent-600 text-primary-50 px-6 py-3 rounded-full hover:from-accent-400 hover:to-accent-500 transition-all duration-300 font-medium flex items-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
        ...
        <div className="text-center animate-fade-in" style={{ animationDelay: '0.8s' }}>
          <button 
            ...
            className="bg-gradient-to-r from-primary-700 to-primary-800 border-2 border-accent-500 text-accent-400 px-12 py-4 rounded-full hover:bg-gradient-to-r hover:from-accent-500 hover:to-accent-600 hover:text-primary-50 transition-all duration-300 font-medium text-lg flex items-center space-x-3 mx-auto shadow-xl hover:shadow-2xl transform hover:scale-105"
          >
